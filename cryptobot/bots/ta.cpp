...
SetUnstablePeriod::SetUnstablePeriod(TA_FuncUnstId id, unsigned int unstablePeriod) {
    this->update(id, unstablePeriod);
}


SetUnstablePeriod *SetUnstablePeriod::create(TA_FuncUnstId id, unsigned int unstablePeriod) {
    SetUnstablePeriod *ta = new SetUnstablePeriod(id, unstablePeriod);
    return ta;
}

void SetUnstablePeriod::update(TA_FuncUnstId id, unsigned int unstablePeriod) {
    this->id = id;
    this->unstablePeriod = unstablePeriod;
}

TA_RetCode SetUnstablePeriod::run() {
    return TA_SetUnstablePeriod(this->id, this->unstablePeriod);
}

SetCompatibility::SetCompatibility(TA_Compatibility value) {
    this->update(value);
}


SetCompatibility *SetCompatibility::create(TA_Compatibility value) {
    SetCompatibility *ta = new SetCompatibility(value);
    return ta;
}

void SetCompatibility::update(TA_Compatibility value) {
    this->value = value;
}

TA_RetCode SetCompatibility::run() {
    return TA_SetCompatibility(this->value);
}

SetCandleSettings::SetCandleSettings(TA_CandleSettingType settingType, TA_RangeType rangeType, int avgPeriod, double factor) {
    this->update(settingType, rangeType, avgPeriod, factor);
}


SetCandleSettings *SetCandleSettings::create(TA_CandleSettingType settingType, TA_RangeType rangeType, int avgPeriod, double factor) {
    SetCandleSettings *ta = new SetCandleSettings(settingType, rangeType, avgPeriod, factor);
    return ta;
}

void SetCandleSettings::update(TA_CandleSettingType settingType, TA_RangeType rangeType, int avgPeriod, double factor) {
...
TA_RetCode SetCandleSettings::run() {
    return TA_SetCandleSettings(this->settingType, this->rangeType, this->avgPeriod, this->factor);
}

RestoreCandleDefaultSettings::RestoreCandleDefaultSettings(TA_CandleSettingType settingType) {
    this->update(settingType);
}


RestoreCandleDefaultSettings *RestoreCandleDefaultSettings::create(TA_CandleSettingType settingType) {
    RestoreCandleDefaultSettings *ta = new RestoreCandleDefaultSettings(settingType);
    return ta;
}

void RestoreCandleDefaultSettings::update(TA_CandleSettingType settingType) {
    this->settingType = settingType;
}

TA_RetCode RestoreCandleDefaultSettings::run() {
